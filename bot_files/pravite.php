                ...
                if ($contactid == $fid) {
                    if (strpos($contactnum, "98") === 0 || strpos($contactnum, "+98") === 0) {
                        ...
                        if ($off["sms1"] == 1) {
                            ...
                            $sms = sendsms($setting["usersms"], $setting["pasms"], $setting["ptid"], $contactnum, "code", $cod);
                            if (is_numeric($sms)) {
                                                    ...
                                                    if (is_numeric($text) && $mindeposit <= $text && $text <= $maxdeposit) {
                                                        ...
                                                        if (0 < $result->num_rows) {
                                                            ...
                                                            if ($code["result"] == "OK") {
                                                                ...
                                                                $bot->sendMessage($fid, $media->text(["pay", $fid, $user["balance"], $code["code"]]), json_encode(["inline_keyboard" => $t]));
                                                                $db->update("users", ["step" => "none"], $fid, ["s"]);
                                                            ...
                                                            if ($contactid == $fid) {
                                                                if (strpos($contactnum, "98") === 0 || strpos($contactnum, "+98") === 0) {
                                                                    ...
                                                                    if ($off["sms2"] == 1) {
                                                                        ...
                                                                        $sms = sendsms($setting["usersms"], $setting["pasms"], $setting["ptid"], $fromNum, $contactnum, "code", $code);
                                                                        if (is_numeric($sms)) {
                                                                            $db->update("users", ["step" => "sendsms2", "ordername" => $contactuser, "price" => $code], $fid, ["s", "s", "i"]);
