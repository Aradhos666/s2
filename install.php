	...
	<form class="form-card" action="function/handler.php?install" method="POST">
		<fieldset class="form-fieldset">
			...
			<div class="form-element form-input">
				...
				<div class="form-element-bar"></div>
				<label class="form-element-label">لایسنس</label><small class="form-element-hint">برای دریافت لایسنس تیکت ارسال کنید</small></div>
			<div class="form-element">
			...
			<div class="form-element">
				...
				<div class="form-element">
					<input class="form-element-field" placeholder=" " type="text" name="fromnum"/>
					<div class="form-element-bar"></div>
					<label class="form-element-label">سرشماره ارسال پیامک</label><small class="form-element-hint">میتوانید پس از نصب نیز وارد کنید</small><small class="form-element-hint">برای تغییر در فایل config.php خط 15 میتوانید تغییر دهید</small></div>
				<div class="form-element">
					...
					<div class="form-element-field">پس از نصب حتما فایل install.php را پاک کنید.   حتما داخل چنل  هم عضو باشید</div>
